...
public class GameController : MonoBehaviour
{
    ...
    bool ValidateGameStateClass()
    {
        ...
        gameStateValid &= EvaluateVariableStatus(potentialGameStateType, "AvailableCrops", typeof(List<>).MakeGenericType(cropType)) == InterfaceStatus.Valid;
        gameStateValid &= EvaluateVariableStatus(potentialGameStateType, "PlantedCrops", typeof(Dictionary<,>).MakeGenericType(new[] { typeof(MonoBehaviour), cropType })) == InterfaceStatus.Valid;
